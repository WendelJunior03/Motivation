...
class Mock {
    ...
    //Listas de frases motiv acionais.
    ...
    //Obtem frases aleatorias de acordo com o filtro
    fun getPhrase(value: Int, lang: String): String {
        val filtered = listPhrases.filter { (it.category == value || value == all) && it.lang == lang }


        val rand = Random.nextInt(filtered.size)
        //retorna um numero aleatorio e retorna uma string
